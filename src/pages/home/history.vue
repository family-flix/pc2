...
<template>
  <scroll-view :store="scroll" class="pt-4">
    <div class="">
      <list-view
        :store="helper"
        class="grid grid-cols-1 gap-2 p-4 sm:grid-cols-2 md:grid-cols-3 xl:grid-cols-4"
      >
        <div v-for="history in response.dataSource" class="cursor-pointer">
          <div class="relative">
            <img
              class="w-full min-h-[180px] object-cover"
              :src="history.poster_path"
              :alt="history.name"
            />
            <div class="absolute top-1 left-1 space-y-2">
              <div v-if="history.has_update">
                ...
                >
                  <div
                    class="text-[14px] leading-none text-gray-800 dark:text-gray-300"
                  >
                    在你看过后有更新
                  </div>
                </div>
              ...
              >
                <div class="">
                  ...
                  >
                    <div
                      class="text-[12px] leading-none text-gray-800 dark:text-gray-300"
                    >
          ...
          <div
            class="relative flex-1 max-w-sm overflow-hidden text-ellipsis mt-2 mb-8"
          >
